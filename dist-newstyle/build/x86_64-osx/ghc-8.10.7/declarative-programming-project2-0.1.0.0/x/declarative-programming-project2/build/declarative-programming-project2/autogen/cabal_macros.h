...
/* package declarative-programming-project2-0.1.0.0 */
#ifndef VERSION_declarative_programming_project2
#define VERSION_declarative_programming_project2 "0.1.0.0"
#endif /* VERSION_declarative_programming_project2 */
#ifndef MIN_VERSION_declarative_programming_project2
#define MIN_VERSION_declarative_programming_project2(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_declarative_programming_project2 */
...
#define CURRENT_COMPONENT_ID "declarative-programming-project2-0.1.0.0-inplace-declarative-programming-project2"
